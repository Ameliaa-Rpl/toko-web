...
function PembeliProfilPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedFile) {
        setUploading(true);
        const uploadRes = await pembeliApi.uploadGambar(selectedFile);
        fotoPath = uploadRes.data.path;
        setUploading(false);
      }

      await pembeliApi.putMe({
        nama_d: form.nama_d,
        nama_b: form.nama_b,
        email: form.email,
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-12">
          <p className="fw-bolder fs-2 mb-0" style={{ fontFamily: 'georgia' }}>Profil Saya</p>
        ...
        <div className="col-lg-8">
          ...
          <div className="card border-0 shadow-sm p-4 mb-4">
            <p className="fw-bold fs-5 mb-3">Informasi Profil</p>
            <form onSubmit={handleSubmit}>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <p className="text-muted" style={{fontSize: "12px"}}>Username tidak dapat diubah</p>
                </div>
              </div>
          ...
          <div className="card border-0 shadow-sm p-4">
            ...
            <form onSubmit={handleChangePassword}>
              ...
              <input type="password" name="passwd_lama" className="form-control mb-2" placeholder="Masukkan password lama" value={passwordForm.passwd_lama} onChange={handlePasswordChange} autoComplete="current-password" required />

              <label className="fw-medium mb-1">Password Baru</label>
              <input type="password" name="passwd_baru" className="form-control mb-2" placeholder="Minimal 6 karakter" value={passwordForm.passwd_baru} onChange={handlePasswordChange} autoComplete='new-password' required minLength={6} />

              <label className="fw-medium mb-1">Konfirmasi Password Baru</label>
              <input type="password" name="passwd_confirm" className="form-control mb-2" placeholder="Konfirmasi password baru" value={passwordForm.passwd_confirm} onChange={handlePasswordChange} autoComplete="new-password" required minLength={6} />
